...
export const SHOWS: Show[] = [
  {
    ...
    time: "Weekdays 6–9am",
    tagline: "The male-female double act that woke up Sydney.",
    hosts: "Mike E (Mike Etheridge) & Emma Chow",
    format:
      "A high-energy male-female breakfast show built around banter, prank calls and listener confessions, glued together with the biggest R&B and hip-hop hits of the moment. Mike E and Emma traded sharp one-liners across three hours, with sponsor reads woven into bits rather than dropped between songs — a true ladies vs. lads dynamic that mirrored the audience listening in.",
    segments: [
      ...
      "Track of the Day — one new R&B or hip-hop release spun on the hour",
    ],
    legacy:
  ...
  },
  {
    ...
    tagline: "R&B and hip-hop to power you through the morning.",
    format:
      "A music-forward mid-morning shift: long sweeps of back-to-back R&B, hip-hop and dance with light, friendly chat between songs. Built for the desks, the cafés and anyone with a pram in one hand.",
    segments: [
  ...
  },
  {
    ...
    format:
      "A solo-host drive show pitched directly at commuters: traffic, weather, news on the quarter, and a heavily front-loaded R&B and hip-hop sweep so the M4 didn't feel quite so brutal. Live crosses to listeners stuck in jams became a signature.",
    segments: [
      "Stuck In Traffic — caller of the day, live from their dashboard",
      "Tomorrow Today — first-play of a song breaking that week",
      "The Wind-Down — final 30 minutes of mellower R&B and neo-soul",
    ],
    legacy:
  ...
  },
  {
    ...
    format:
      "Three hours of beat-matched hip-hop, R&B and dance remixes, mixed live by a rotating roster of Sydney club DJs. No talk breaks once the mix dropped — pure runway from the kitchen to the cab.",
    segments: [
  ...
  },
  {
    ...
    time: "Sat 9am–12pm",
    tagline: "The 30 biggest R&B and hip-hop songs in the country.",
    format:
